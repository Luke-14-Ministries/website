...
// the information@ shared mailbox in M365, with several staff on it. Replies
// now reach people who read them. (The first attempt put it on a mailbox at
// info@ that staff could never find in Outlook's picker; information@ replaced
// it on 27 Aug and carries info@ and registration@ as aliases.)
//
...
export function registrationConfirmationEmail({
  ...
  const deposit = depositCents > 0
    ...
    <p style="margin:0 0 12px;">
      ...
      $${(depositCents / 100).toFixed(2)} deposit secures your spot, and you can pay it on
      your dashboard whenever you're ready. If the fee is difficult, &ldquo;Request help
