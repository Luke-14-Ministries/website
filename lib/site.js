...
export const site = {
  ...
  //
  // camp@ is deliberately absent. It is still an alias and still receives, so
  // an old flyer or a family's saved contact keeps working, but it is no
  // longer printed anywhere on the site or in any email. It is being allowed
  // to fall out of use rather than switched off.
  //
