...
//
// The From address follows the pending staff decision on sender identity
// (Staff Questions §6). Until that lands, registration mail is sent as
// registration@ -- the address families already see on account emails.
