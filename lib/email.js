...
// does not exist in M365: replies to it bounced. The Stripe receipts moved to
// camp@ for that reason on 25 Aug and this was left behind, which would have
// gone unnoticed until the Resend key went live and the very first
// confirmation email started collecting undeliverable replies.

const FROM = 'Luke 14 Ministries <camp@luke14ministries.net>';
